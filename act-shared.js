/* CW Account Changes shared script. Build 2026-09-05d (chat thread on every entry with a Chat column and needs-a-reply badge; section tables fit the page width, no sideways scrolling; c: dropdown-style comboboxes with caret and arrow keys; pick-lists on free-text fields from history).
   ...
   accounting-queue.html and accounts.html (Admin Hub). Loaded from
   https://citywidelv.github.io/cw-admin-hub/act-shared.js on every page.
...
var ADMINURL = "https://citywidelv.github.io/cw-admin-hub/";
...
window.ACT = { WEBHOOK: WEBHOOK, OPS: OPS, ADMIN: ADMINURL, REGIONS: REGIONS, REGION_KEY: REGION_KEY, KEY_REGION: KEY_REGION, FIXED_ICS: FIXED_ICS,
